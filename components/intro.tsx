    ...
    <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
            ...
            <motion.div
             ...
             transition={{
                ...
                className='h-48 w-48 rounded-full object-cover 
                 border-[0.35rem] border-white shadow-xl'></Image>
            </motion.div>
        </div>
      ...
      <motion.div className='flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium'
        ...
        <a className='group bg-white px-7 py-3 flex 
          ...
          dark:bg-white/10 dark:text-white/60' href='/Lebenslauf-neuer.pdf' download>
            CV Herunterladen <HiDownload className='opacity-60 group-hover:translate-y-1 transition'/>{" "}
        </a>
        <a className='bg-white p-4 text-gray-700 flex 
          items-center gap-2 text-[1.35rem] rounded-full outline-nonefocus:scale-[1.15] hover:scale-[1.15] 
          hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack 
          dark:bg-white/10 dark:text-white/60'
          href='https://www.linkedin.com/in/yunusemre-kaya/' target='_blank'>
          <BsLinkedin/>
        </a>
        <a className='bg-white p-4 text-gray-700 flex 
          items-center gap-2 text-[1.35rem] rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15]
          hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack 
          dark:bg-white/10 dark:text-white/60'
          href='https://github.com/avyunusemre' target='_blank'>
          <FaGithubSquare/>
        </a>
        <a className='bg-white p-4 text-gray-700 flex 
          items-center gap-2 text-[1.35rem] rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15]
          hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack 
          dark:bg-white/10 dark:text-white/60'
          href='https://www.youtube.com/@software-career' target='_blank'>
          <BsYoutube/>
        </a>
      </motion.div>
